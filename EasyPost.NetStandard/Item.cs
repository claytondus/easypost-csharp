...
namespace EasyPost {
    public class Item : Resource {
        ...
        public static async Task<Item> Retrieve(string id) {
            Request request = new Request("items/{id}");
            request.AddUrlSegment("id", id);

            return await request.Execute<Item>();
        }
        ...
        /// </param>
        /// <returns>EasyPost.Item instance.</returns>
        public static async Task<Item> Create(Dictionary<string, object> parameters) {
        ...
        /// <returns>EasyPost.Item instance.</returns>
        public static async Task<Item> RetrieveReference(string name, string value) {
