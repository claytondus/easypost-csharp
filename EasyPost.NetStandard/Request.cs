    ...
    public class Request {
        ...
        */
        ...
        public async Task<T> Execute<T>() where T : new() {
            ...
            return await client.ExecuteAsync<T>(this);
        }
        ...
        internal List<Tuple<string, string>> FlattenParameters(IDictionary<string, object> parameters, string parent) {
            ...
            foreach (KeyValuePair<string, object> pair in parameters) {
                ...
                } else if (pair.Value is IList && pair.Value.GetType().GetTypeInfo().GenericTypeArguments.Single().GetTypeInfo().ImplementedInterfaces.Contains(typeof(IResource))) {
                    FlattenList(parent, result, pair);
