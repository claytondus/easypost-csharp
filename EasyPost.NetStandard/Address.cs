...
namespace EasyPost {
    public class Address : Resource {
        ...
        public async Task Create() {
            await Create(verify, verify_strict);
        }
        ...
        /// </param>
        /// <exception cref="ResourceAlreadyCreated">Address already has an id.</exception>
        public async Task Create(List<string> verifications = null, List<string> strictVerifications = null) {
            if (id != null)
                throw new ResourceAlreadyCreated();
            Merge(await sendCreate(this.AsDictionary(), verifications, strictVerifications));
        }

        private static async Task<Address> sendCreate(Dictionary<string, object> parameters, List<string> verifications = null, List<string> strictVerifications = null) {
        ...
        public static async Task<Address> CreateAndVerify(Dictionary<string, object> parameters = null) {
            ...
            return await Address.Create(parameters);
        }
    }
}