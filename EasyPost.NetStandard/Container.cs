...
namespace EasyPost {
    public class Container : Resource {
        ...
        public static async Task<Container> Retrieve(string id) {
            Request request = new Request("containers/{id}");
            request.AddUrlSegment("id", id);

            return await request.Execute<Container>();
        }
        ...
        /// </param>
        /// <returns>EasyPost.Container instance.</returns>
        public static async Task<Container> Create(Dictionary<string, object> parameters) {
