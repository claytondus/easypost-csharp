...
namespace EasyPost {
    public class Shipment : Resource {
        ...
        public static async Task<ShipmentList> List(Dictionary<string, object> parameters = null) {
            Request request = new Request("shipments");
            request.AddQueryString(parameters ?? new Dictionary<string, object>());

            ShipmentList shipmentList = await request.Execute<ShipmentList>();
        ...
        public static async Task<Shipment> Create(Dictionary<string, object> parameters = null) {
        ...
        public async Task Buy(string rateId) {
        ...
        /// </summary>
        public async Task GenerateStamp() {
        ...
        public async Task<Rate> LowestRate(IEnumerable<string> includeCarriers = null, IEnumerable<string> includeServices = null,
